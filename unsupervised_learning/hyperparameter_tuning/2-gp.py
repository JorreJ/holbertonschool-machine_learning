...
class GaussianProcess:
    ...
    def update(self, X_new, Y_new):
        """Update a Gaussian Process with a new data point.

        Args:
            X_new (numpy.ndarray): A 1D or 2D array with the new input point.
            Y_new (numpy.ndarray): A 1D or 2D array with the new output point.
        """
