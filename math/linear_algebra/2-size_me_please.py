...
"""
This module provides a utility function to determine the shape of a nested list (matrix).
...
def matrix_shape(matrix):
    ...
    At each level, it appends the length of the current list to the 'shape' list
    and then moves to the next nested level by selecting the first element,
    until it reaches a non-list element.
    """
