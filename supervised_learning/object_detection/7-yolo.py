...
class Yolo:
    ...
    def predict(self, folder_path):
        """Predict & display object detection bounding boxes on folder images.
        ...
        Returns:
            tuple: A tuple containing:
                - predictions (list): A list of tuples for each image:
                 (box_predictions, predicted_box_classes, predicted_box_scores)
                - image_paths (list): A list of paths to the individual images.
        """
